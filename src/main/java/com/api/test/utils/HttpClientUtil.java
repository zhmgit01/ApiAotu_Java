...
public class HttpClientUtil {
    ...
    public static HttpClientResult doGet(String url, Map<String, String> headers, Map<String, String> params) throws Exception {
        ...
        //携带请求参数的url，get请求的参数特点，拼接在url地址后面，处理请求参数
        if (params != null){
     ...
     * @throws Exception
     */
    public static HttpClientResult doPost(String url, Map<String, Object> params) throws IOException {
     ...
     * @throws Exception
     */
    public static HttpClientResult doPost(String url, Map<String, String> headers, Map<String, Object> params) throws IOException {
     ...
     * @throws Exception
     */
    public static HttpClientResult doPut(String url,Map<String, String > headers, Map<String,Object> params) throws IOException {
        //c创建httpClient对象
        CloseableHttpClient httpClient = HttpClients.createDefault();
        //创建httpPut对象
...
//        }
        //将请求参数转换为json格式
        if (HttpEntityEnclosingRequestBase.class.isAssignableFrom(httpMethod.getClass())){
            if (params != null){
                StringEntity entity = new StringEntity(new JSONObject(params).toJSONString(), ContentType.APPLICATION_JSON);
